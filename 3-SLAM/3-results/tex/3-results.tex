...
\cref{fig:comparison_spider} presents four radar plots comparing the baseline, refined, and GLIM-GNSSs across all five datasets. The four metrics displayed are error per metre, error percentage per metre, ATE, and RPE 1\,m translation standard deviation. Radial axes are plotted on a logarithmic scale.
...
\begin{figure}[htbp]
     ...
     \end{subfigure}
     \caption{Spider plot comparisons of the GLIM baseline, refined, and GLIM-GNSSs for key performance metrics.}
