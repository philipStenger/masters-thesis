...
each $n$ sample point is the only representative in each axis-aligned hyperplane. A comparison of LHS, MCS and Grid Search is detailed in Table~\ref{tab:sampling_comparison}.
